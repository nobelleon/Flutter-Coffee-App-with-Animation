...
import 'package:coffee_ui/src/core/route/route_names.dart';
...
import 'package:coffee_ui/src/features/presentation/quantity_page/bloc/quantity_page_bloc.dart';
    ...
    return Opacity(
      ...
      child: GestureDetector(
        ...
        child: Container(
          ...
          child: Image.asset('assets/img/coffee/bean icon.png'),
        ),
      ),
    );
  }
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(
          ...
          boxShadow: [
            BoxShadow(
              color:
                  ColorConstants.brownColor.withOpacity(isSelected ? 0.9 : 0.0),
              offset: const Offset(0, 13),
              blurRadius: 25,
              spreadRadius: 4,
            ),
